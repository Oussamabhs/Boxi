...
<?php
// Assurez-vous que $produits est défini et n'est pas vide
if (isset($produits) && is_array($produits) && count($produits) > 0) {
...
<?php
    ...
    // Gérez le cas où $produits n'est pas défini ou est vide
